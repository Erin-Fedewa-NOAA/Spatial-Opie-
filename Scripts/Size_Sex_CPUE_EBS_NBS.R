# notes ----
#Multiple approaches for survey abundance and error estimates
  # Evaluate Abundance and CPUE by size sex group in EBS and NBS
  #See strat_abund_est script for final approach for calculating abundances in Fig 5 
# Tyler Jackson
...
crab %>%
  mutate(size_sex = ifelse(sex == 1 & cw > 30 & cw <= 60, "male31to60",
                           ifelse(sex == 1 & cw > 60 & cw <= 90, "male61to90",
                                  ifelse(sex == 1 & cw > 90 & cw <= 120, "male91to120",
...
## make 2019 EBS stratum_fish the same as 2018
haul_ebs %>%
